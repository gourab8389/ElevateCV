            ...
            <div className="mt-2 px-1 pb-1">
              ...
              {filteredDocuments?.map((doc) => (
                <div
                  ...
                  className="text-sm rounded-s w-full hover:bg-primary/5 flex items-center justify-between py-1 px-1 cursor-pointer"
                >
                  ...
                  <div
                    ...
                    className="rounded-sm hover:bg-neutral-200 w-6 h-6 flex items-center justify-center dark:hover:bg-gray-700 cursor-pointer"
                  >
                    {isPending ? (
